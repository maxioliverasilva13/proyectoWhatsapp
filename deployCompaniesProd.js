...
async function deployCompany(empresa) {
  ...
  // Ejecutar todos los comandos SSH en una sola conexión
  await execSync(`
    ssh -i private_key -o StrictHostKeyChecking=no root@${dropletIp} '
  ...
  // Copiar archivo .env y ejecutar docker compose en una sola conexión
  await execSync(`
...
async function deployApp() {
  ...
  // Ejecutar comandos de preparación en una sola conexión SSH
  await execSync(`
    ssh -i private_key -o StrictHostKeyChecking=no root@${dropletIp} '
  ...
  // Copiar .env y ejecutar docker compose en una sola conexión
  await execSync(`
